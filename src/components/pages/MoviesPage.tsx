      ...
      <main className="flex-1">
        ...
        <section className="w-full bg-background">
          <div className="max-w-6xl mx-auto px-6 pt-16 pb-12">
            ...
            <p className="mt-4 font-paragraph text-lg text-secondary max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <select
                ...
                className="h-11 px-4 border border-light-gray bg-background"
              >
                {allGenres.map((g) => (
        ...
        <section className="w-full bg-background">
          <div className="max-w-6xl mx-auto px-6 pb-20 grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isActive
                        ? "border-foreground"
                        : "border-light-gray hover:border-foreground/40"
                    )}
                    style={{
                      boxShadow: isActive
                        ? `0 0 0 1px ${m.accentColor} inset`
                        : undefined,
                    }}
                  >
                    <div className="relative aspect-[2/3] overflow-hidden bg-light-gray">
                      <Image
                        src={m.posterUrl}
                        alt={m.title}
                        width={900}
            ...
            <div className="lg:col-span-5">
              {activeMovie && (
                <div
                  className="border border-light-gray bg-background"
                  style={{
